...
class ProduitsControllerTest < ActionController::TestCase
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post :create, produit: { description: @produit.description, id_cat: @produit.id_cat, libelle: @produit.libelle, prix: @produit.prix }
    end
  ...
  test "should update produit" do
    put :update, id: @produit, produit: { description: @produit.description, id_cat: @produit.id_cat, libelle: @produit.libelle, prix: @produit.prix }
    assert_redirected_to produit_path(assigns(:produit))
  end
